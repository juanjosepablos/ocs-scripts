...
msiexec /qn /norestart /x {08D2F839-A9FD-4F5A-A529-D45FF6E238A3}
::OpenOffice.org 2.2 
msiexec /qn /norestart /x {51F86E9B-0D0D-4080-BD70-9B0C275ABD5E}
::OpenOffice.org 2.3 
...
msiexec /qn /norestart /x {92B79901-C57D-409F-8D2F-4E5337383569}
msiexec /qn /norestart /x {F72EACD9-3ED6-41D9-A49D-E06542992B9F}
msiexec /qn /norestart /x {6860B340-530D-46B3-91F8-1AE1F70F7C33}

:: OpenOffice 3.1.0 / 3.1.1
msiexec /qn /norestart /x {A16B3EA2-8798-4960-8D8B-18D3149AD617}
msiexec /qn /norestart /x {AFB21BFE-40E6-42FB-A010-B80F417D8E71}
msiexec /qn /norestart /x {43A650AA-D1DC-4C52-8819-D7848B3A08DA

:: OpenOffice 3.1.1
msiexec /qn /norestart /x {D765F1CE-5AE5-4C47-B134-AE58AC474740}
msiexec /qn /norestart /x {A01E0232-CA9E-4FA2-BAA1-39358D753353}
